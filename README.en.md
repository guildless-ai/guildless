...
Artifact Definition of Done and Asset Ledger rules are documented in [`docs/artifact-system.md`](docs/artifact-system.md). GitHub is not the default delivery route for every artifact.
